...
export default function AddHabit() {
  ...
  return (
    <Panel>
      <PanelTrigger>
        <div className="p-4 border-2 cursor-pointer border-green-400 dark:border-green-800 dark:hover:bg-gray-300/10 hover:bg-green-300/50 transition rounded-md">
